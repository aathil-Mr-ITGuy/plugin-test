...
function my_slider(){
	...
	$result .= 'for($i=0;$i<$post_count; $i++):'
		  <li data-target="#carousel-example-generic" data-slide-to="';echo $i; echo'" class="active"></li>';
			  endfor;
	   echo'</ol>
	   <div class="carousel-inner">';
			  while($slider->have_posts()) : $slider->the_post();
		  echo '<div class="item'; echo $j==0 ? ' active': '';echo'">';
		  echo'<a href="';echo get_post_meta(get_the_ID(),'_slider_link_value_key', true); echo'">'; 
		  if(has_post_thumbnail()): the_post_thumbnail('slider'); endif; echo'</a>
			
		  </div>';
			  $j++; endWhile; wp_reset_query();
	   echo'</div>
...
add_shortcode( 'my_slider', 'my_slider' ); 